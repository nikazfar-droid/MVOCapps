...
exports.processGalleryImage = exports.uploadImageFromUrl = void 0;
 ...
 */
exports.uploadImageFromUrl = functions.region('asia-southeast1').runWith(runtimeOpts).https.onCall(async (data, context) => {
...
exports.processGalleryImage = functions
    ...
    if (!contentType?.startsWith('image/'))
        return null;
    if (!filePath || !filePath.includes('gallery_raw/'))
        return null;
